# Claude Code Tools — claude-fable-5

9 tools were sent to the model in this capture (headless `-p` mode uses a deferred-tool set — note `ToolSearch`, which lazily loads the rest on demand).
